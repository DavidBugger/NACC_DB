...
<?php
	if(isset($_POST['update'])){
		...
		if (isset($_FILES['image']['tmp_name'])) {
			...
			if($name!=NULL && $fathers_name!=NULL && $mothers_name!=NULL && $present_address!=NULL && $permanent_address!=NULL && $age!=NULL && $roll_number!=NULL && $session!=NULL && $year!=NULL && $course!=NULL && $hobbies!=NULL && $location!=NULL){
			
			$sql = "UPDATE users SET name='$name',fathers_name='$fathers_name',mothers_name='$mothers_name',present_address='$present_address',permanent_address='$permanent_address',age='$age',roll_number='$roll_number',session='$session',year='$year',course='$course',hobbies='$hobbies',image='$location' WHERE name = '$login_session'";
