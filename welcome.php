...
?>
   ...
   <?php require_once'menubar.php';?>
	  ...
	  <br><br>
	  <h2 style="font-family:Bernard MT Condensed; color:#06857C;">Corper's Profile</h2>
            ...
            <div class="panel-body">
				...
				<?php
					...
					while($row = mysqli_fetch_array($result)){
						...
						echo "</tr>";
						echo "<tr>";
						echo "<th><b>Year of Service:</b></th>";
						echo "<td>".$row['year']."</td>";
						echo "</tr>";
						echo "<tr>";
						echo "<th><b>Course of Study:</b></th>";
						echo "<td>".$row['course']."</td>";
						echo "</tr>";
						echo "<tr>";
						echo "<th><b>Hobbies:</b></th>";
