...
$result=mysqli_query($conn,"SELECT * FROM taraba_corper WHERE scode =$id ");
...
while($row=mysqli_fetch_array($result)){
	...
	echo "<b style='font-size:16px;'>".$row['scode']."</b><br/>";
	echo "<i>".$row['m_status']."</i><br/>";
	echo "<b>Status: &nbsp;</b>".$row['deployed_state'];
	echo "</div>";
	
	echo "<br/>";
	echo "<div class='col-md-6'>";
	echo "<b>Course Taken: </b><br/>";
	$desc = $row['institution'];
